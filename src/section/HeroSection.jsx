...
export default function HeroSection() {
    ...
    return (
        <section className='flex flex-col items-center justify-center px-4 md:px-16 lg:px-24'>
            ...
            <Link 
            to="/signup" className='mt-32 flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-sm font-medium transition hover:bg-gray-100/80'>
            ...
            <h1 className='mt-4 max-w-3xl scale-105 bg-gradient-to-r from-black to-[#748298] bg-clip-text text-center text-4xl/12 font-bold text-transparent md:scale-100 md:text-6xl/20'>Fraud-proof tickets? QR & NFC tickets is the answer.</h1>
            <p className='mt-2 max-w-xl text-center text-base/7 text-gray-700'>We’ve got you covered against ticket fraud, giving event organizers peace of mind with QR and NFC tickets designed to prevent copying, reuse, and unauthorized access.</p>

            <Link to="/signup" className='mt-8 flex items-center gap-2 rounded-full bg-gray-900 px-8 py-2.5 font-medium text-white transition hover:opacity-90'>
